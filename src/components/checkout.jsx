                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    ...
                    <div className="user-actions accordion" data-aos="fade-up" data-aos-delay={200}>
                      ...
                      <div id="checkout_coupon" className="collapse" data-parent="#checkout_coupon">
                        <div className="checkout_info">
                          <form action="#">
                      ...
                      <form action="#">
                        ...
                        <div className="row">
                          ...
                          <div className="col-12">
                            ...
                            <div id="newAccountPassword" className="collapse" data-parent="#newAccountPassword">
                          ...
                          <div className="col-12 mb-20">
                            ...
                            <div id="anotherShipping" className="collapse" data-parent="#anotherShipping">
                              <div className="row">
                                <div className="col-lg-6 mb-20">
                                  <div className="default-form-box">
                                    <label>First Name <span>*</span></label>
